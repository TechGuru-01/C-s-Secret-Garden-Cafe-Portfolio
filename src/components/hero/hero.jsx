      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-center lg:text-left items-center lg:items-start">
          ...
          <motion.div
            ...
            className="mt-8 flex flex-col sm:flex-row gap-4 sm:items-center w-full sm:w-auto"
          >
            {/* View Menu */}
            <button
            ...
            >
              ...
              <span>Book Our Garden in Advance</span>
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 grid grid-cols-3 gap-6 pt-8 border-t border-white/10 w-full"
          >
            <div>
        ...
        {/* Right Side: Added `hidden md:flex` to eliminate layout height footprint on mobile devices */}
        <div className="hidden md:flex lg:col-span-5 relative h-[380px] sm:h-[450px] lg:h-[500px] items-center justify-center mt-12 lg:mt-0">
          ...
          <motion.div
            ...
            className="absolute max-md:hidden top-4 left-4 w-7/12 sm:w-[260px] aspect-[3/4] rounded-2xl overflow-hidden border-4 border-white shadow-xl bg-white"
          >
            <div
          ...
          <motion.div
            ...
            className="absolute bottom-4 right-4 w-6/12 sm:w-[220px] aspect-square max-md:hidden rounded-2xl overflow-hidden border-4 border-white shadow-2xl bg-white"
          >
            <div
              className="w-full h-full bg-cover bg-center hover:scale-105 transition-transform duration-700"
              style={{
          ...
          <motion.div
            ...
            className="absolute max-md:hidden bottom-16 left-8 bg-black/40 backdrop-blur-md border border-white/10 p-4 rounded-xl shadow-lg flex items-center gap-3 max-w-[200px] sm:max-w-[220px]"
          >
