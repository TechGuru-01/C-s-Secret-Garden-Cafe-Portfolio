...
export default function Contact() {
  return (
    <section id="contact" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-cream/30 overflow-hidden border-b border-sunflower/10">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-sm text-charcoal/70 mt-3 leading-relaxed">
            Have a question, feedback, or planning an intimate proposal or bridal shower? Send our garden coordinators a message or visit us directly.
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <div className="p-5 rounded-2xl bg-white border border-sunflower/15 shadow-sm flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-serif font-bold text-sm text-charcoal">Address</h4>
              ...
              <div className="p-5 rounded-2xl bg-white border border-sunflower/15 shadow-sm flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-serif font-bold text-sm text-charcoal">Reservations Line</h4>
            ...
            >
              ...
              <div className="space-y-2.5 font-sans text-xs text-charcoal/80">
                <div className="flex justify-between border-b border-charcoal/5 pb-1.5">
                  <span className="font-medium text-charcoal/70">Monday - Thursday</span>
                  <span className="font-semibold">9:00 AM - 9:30 PM</span>
                </div>
                <div className="flex justify-between border-b border-charcoal/5 pb-1.5">
                  <span className="font-medium text-charcoal/70">Friday - Sunday</span>
                  <span className="font-semibold text-sunflower">9:00 AM - 10:00 PM</span>
                </div>
                <div className="flex justify-between text-[11px] text-charcoal/50 pt-1 italic">
                  <span>* Final kitchen orders are accepted 30 minutes before closing.</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-sunflower text-white px-5 py-3.5 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-serif text-sm font-bold">Interactive Location Guide</span>
                </div>
                <span className="font-mono text-[9px] font-bold text-white">525 J. LALLANA ST.</span>
              </div>
              ...
              <div className="relative h-64 bg-cream/15 p-4 flex flex-col items-center justify-center border-b border-sunflower/10">
                ...
                <div className="absolute inset-0 bg-cover bg-center opacity-10 pointer-events-none" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&q=80&w=400')" }} />
                
                {/* SVG Mock Map Roads layout */}
                <svg className="absolute inset-0 w-full h-full text-sunflower/20 opacity-40 pointer-events-none" viewBox="0 0 100 100" preserveAspectRatio="none">
                  ...
                  <line x1="85" y1="0" x2="85" y2="100" stroke="currentColor" strokeWidth="1.5" />
                ...
                <div className="absolute top-8 left-1/4 text-[9px] font-semibold text-charcoal/40 font-mono select-none">Rafael Palma High</div>
                <div className="absolute bottom-12 right-12 text-[9px] font-semibold text-charcoal/40 font-mono select-none">San Antonio Plz</div>

              </div>

              {/* Map footer navigation CTA */}
              <div className="p-4 bg-cream/30 flex justify-between items-center text-xs">
                <span className="text-charcoal/60 leading-tight">Quiet seclusion in San Antonio</span>
                <a 
