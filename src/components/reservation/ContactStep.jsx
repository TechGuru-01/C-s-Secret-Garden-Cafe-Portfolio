    ...
    <form onSubmit={onSubmit} className="space-y-6 text-left">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-cream/30 border border-sunflower/20 focus:border-sunflower focus:ring-1 focus:ring-sunflower outline-none text-sm text-charcoal font-medium"
          />
        </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-xl bg-cream/30 border border-sunflower/20 focus:border-sunflower focus:ring-1 focus:ring-sunflower outline-none text-sm text-charcoal font-medium resize-none"
        />
      </div>
