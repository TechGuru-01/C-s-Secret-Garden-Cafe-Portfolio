...
// Asymmetric style mapping that preserves the Bento structure on mobile screens
const getGridCardClasses = (index, isBento) => {
  ...
  switch (index) {
    case 0: // Main featured photo (Large 2x2 commanding block across mobile and desktop)
    ...
    case 3: // Wide footer card spanning cleanly across the 2-column mobile/tablet layout
...
// Orchestration variants for a clean cascade entry effect
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        {/* Gallery Filter Navigation Container with Swipe Indicators */}
        <div className="w-full flex flex-col items-center mb-12 relative px-2">
          {/* Subtle scroll masks for mobile fading views */}
            ...
            >
              {["food", "atmosphere", "moments"].map((tab) => {
                ...
                return (
                  ...
                  >
                    {/* Smooth fluid tab background slide */}
                    {isActive && (
                      <motion.div
          ...
          {/* Micro Mobile Swipe Indicator Hint */}
        ...
        {/* Bento Grid Layout - Retaining Asymmetry on Small Viewports */}
